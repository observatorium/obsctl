...
func init() {
	...
	loginCmd.Flags().String("observatorium-api-url", "", "The URL of the Observatorium API.")
	loginCmd.Flags().String("observatorium-ca", "", "Path to the TLS CA against which to verify the Observatorium API. If no server CA is specified, the client will use the system certificates.")
